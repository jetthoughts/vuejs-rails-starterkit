...
## Table of Contents
- [Generate Ruby on Rails Project with Vue.js](#generate-ruby-on-rails-project-with-vuejs-no-turbolinks-included-on-this-stage)
- [Setup development environment](#setup-development-environment)
- [Add sample page to host Vue.js component](#add-sample-page-to-host-vuejs-component)
- [Use Webpacker assets in the application](#use-webpacker-assets-in-the-application)
- [Install Jest for Component Unit Tests](#install-jest-for-component-unit-tests)
- [Setup Heroku and Deploy](#setup-heroku-and-deploy)
- [Setup basic PWA](#setup-basic-pwa)
- [Setup Turbolinks](#setup-turbolinks)
- [Setup AdminLTE](#setup-adminlte)
- [Configure continuous integration and other services for static code
